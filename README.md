...
docker system prune - czysci nieuzywane kontenery
docker images - pokazuje obrazy
docker images --all pokazuje wszystkie obrazy
docker image prune - czysci nieuzywane obrazy
docker image history [image] - czynnosci wykonywane na obrazie
docker start [id] - start konterera
